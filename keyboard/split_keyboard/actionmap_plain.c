...
#define AC_RAISE            ACTION_LAYER_MOMENTARY(2)
#define AC_LOWER            ACTION_LAYER_MOMENTARY(3)
...
const uint16_t PROGMEM actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = ACTIONMAP(
        /* left hand */
            ...
            ESC  , A    , S    , D    , F    , G    ,
            LSFT , Z    , X    , C    , V    , B    ,
            LCTL , LGUI , LALT , NO   , NO   , SPC  , LOWER,
        /* right hand */
                   6    , 7    , 8    , 9    , 0    , FN1  ,
                   Y    , U    , I    , O    , P    , BSPC ,
                   H    , J    , K    , L    , SCLN , QUOT ,
                   N    , M    , COMM , DOT  , SLSH , ENT  ,
            RAISE, SPC  , BSPC , LEFT , DOWN , UP   , RGHT
    ),
    /* Gaming */
    [1] = ACTIONMAP(
        /* left hand */
        ...
        /* right hand */
                   NLCK , PSLS , PAST , PMNS , NO   , TRNS ,
                   P7   , P8   , P9   , PPLS , NO   , NO   ,
                   P4   , P5   , P6   , PEQL , NO   , NO   ,
                   P1   , P2   , P3   , PCMM , UP   , PENT ,
            TRNS , SPC  , P0   , PDOT , LEFT , DOWN , RGHT
    ),
    /* Raise */
    [2] = ACTIONMAP(
        /* left hand */
            ...
            TRNS , TRNS , TRNS , TRNS , TRNS , TRNS , TRNS ,
        /* right hand */
                   FN0  , NO   , NO   , NO   , PROMICRO_PROGRAM , PROMICRO_RESET ,
                   NO   , NO   , NO   , NO   , NO   , NO   ,
                   F1   , F2   , F3   , F4   , F5   , F6   ,
                   F7   , F8   , F9   , F10  , F11  , F12  ,
            TRNS , SLEP , NO   , NO   , NO   , NO   , NO
   ),
   /* Lower */
   [3] = ACTIONMAP(
       /* left hand */
            NO   , NO   , NO   , NO   , NO   , VOLU ,
            NO   , NO   , NO   , NO   , NO   , VOLD ,
            NO   , NO   , NO   , MPRV , MPLY , MNXT ,
            NO   , NO   , NO   , INS  , HOME , PGUP ,
            NO   , NO   , NO   , DEL  , END  , PGDN , TRNS ,
        /* right hand */
                   TRNS , TRNS , TRNS , TRNS , TRNS , TRNS ,
                   TRNS , TRNS , TRNS , TRNS , TRNS , TRNS ,
                   TRNS , TRNS , TRNS , TRNS , TRNS , TRNS ,
